 ...
 * a string //STRING!! into individual logical units called <b><i>tokens</i></b>.
 */
 ...
 * -----------------------------
 * Controls how the scanner treats tokens enclosed in quotation marks.  By //by default:默认情况下
 * default, quotation marks (either single or double) are treated just like
 * any other punctuation character.  Calling
 *///控制扫描程序如何处理括在引号中的标记。默认情况下，引号(单引号或双引号)会被当作任何其他标点符号
 /*<pre>
 *    scanner.scanStrings();
 *</pre>
 *
 ...
 * The quotation marks//引号 are returned as part of the scanned token so that
